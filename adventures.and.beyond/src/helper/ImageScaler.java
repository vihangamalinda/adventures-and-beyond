...
public class ImageScaler {
    private static BufferedImage getScaledImage(int upScale,
                                                BufferedImage original) {
        BufferedImage scaledImage = new BufferedImage(upScale,
                                                      upScale,
                                                      original.getType());
